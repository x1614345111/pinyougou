					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a class="{{isSelected('${specification.attributeName}','${item}')==true?'selected':''}}"
									   ng-click="selectSpecification('${specification.attributeName}','${item}')" href="javascript:;">${item}
